...
# Creates Favourites table (users favourites athletes)
mycursor.execute("CREATE TABLE Favourites (user_id VARCHAR(255), athlete_id VARCHAR(255), PRIMARY KEY(user_id, "
