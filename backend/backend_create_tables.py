...
# Creates User table
mycursor.execute("CREATE TABLE User (id INT AUTO_INCREMENT, first_name VARCHAR(255), surname VARCHAR(255), "
                 "fav_country VARCHAR(255), email VARCHAR(255), username VARCHAR(255), password VARCHAR(255), "
                 "PRIMARY KEY (id), FOREIGN KEY (fav_country) REFERENCES Country(country_code))")

# Creates Athlete table
mycursor.execute("CREATE TABLE Athlete (id INT, first_name VARCHAR(255), surname VARCHAR(255), "
...
mycursor.execute("CREATE TABLE Friends (user_id INT, friend_id INT, PRIMARY KEY(user_id, "
...
mycursor.execute("CREATE TABLE Participates (athlete_id INT, event_name VARCHAR(255), year INT, "
